...
const [history ,setHistory]=useState([])
  ...
  return (
    <>
        ...
        <i class="fa-solid fa-arrow-left fa-beat me-2"></i>Back to Home
        </Link>
        ...
        <table className='table mt-5 mb-5 container'>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><button onClick={()=>removeHistory(item?.id)} className='btn btn-danger'><i className='fa-solid fa-trash-can'></i></button></td>
            </tr>))
            :
